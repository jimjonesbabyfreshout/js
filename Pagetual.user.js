...
// @icon data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAMAAACdt4HsAAAAdVBMVEUAAAD3V U33VU32VEz8U073VU32VU33VU32VUz0Uk/3VE32VU32VU2VU32VU32VU32VU32VU33VU0z2VU34Wkv3VE32VUz/mpj/nJj2VUz2V U32VE33VEz2VU32VU32VUz3VE32VEz3VE3/mZf2Vkz2VU3/mpilFFolAAAAJXRSTlMA3Lp/GvTBT5YQLuawZ/DOyZwlPQeKc21N0 4+FX1bqpm9DNoB4T68ePwAAAitJREFUWMPt1tuasiAUBuCFCG5Rs3QybTPV1/1f4v/3PDkyIojn8x5qBrI+ltAfh32/yysmBKvyX b+njb6bDL9kzTd5SzjDAsYT8nFoGSxYe6BVqoNDp2jFDit25BRgVUAODB4YWcETWVTwVNGiGN5iWtBgg4YMCpsoI38dNunmmWyxU TvbPwwbsYR0fIzZLQ0pTG8eieRmBLMmpdH9uimQEf6TNRnXXKLZHixpJtywLzOgMHtFCqdM64DahHRnOE1dsrekm9wr2WtLcAlpd Hwcp1pAJySXYnERclzp4+v19jXdmcTvQUJtz+ZaI4i05/V/UGYrCxbaAsOYoNfIKEQxpqQuzCgJJJ/3f42O8ywEZuMVWi/8hODxG j3GW2b0udkbGULLDOjimAG0S3fLGlBnXQM9irG1CiQdVQi0dqQsOSDlyEEz7Vy9OxxfR71VCXsSB23jMrKJYZXSjw57sqgLn5Z0w olsOCz0RyJkyeYjgz7pwwVq20eboZwtVUl2EnN5gJ50dQZFdryATvABRTr/tJXkUMdaAK5pwtCapwtFLskguwuyMh/Sd9WChQ4sI vIUYSk3PYqQvCQlOC04IfN7PkdjOyRKWhdKXMmiAFt9i3sJ5jxoRuR0vqAghxxwHuqfQE5OHGDKOrwEnqs1DgAZ2e4Eev1d45TN7 JfhrQLKgfwMFYAsvp33dXII073aVQLI2gN5S58lfmGnKKFtah7nkgnBZB7zlP7Y/QNiTM6sYNzawwAAAABJRU5ErkJggg==
...
If (window.name === 'pagetual-iframe' || (window.frameElement && window.frameElement.name === 'paget Ual-iframe')) {
...
If (getComputedStyle(document.documentElement).display == 'none') document.documentElement.style.dis Play = 'block';
...
enableDebug: "Debug mode, output information to the console",

Disable: "temporarily disable",

disableSite: "Site disable switch",

disableSiteTips: "It has been disabled on this site",
...
toBottom: "Go to the end of the page",

Current: "current page",

forceIframe: "Forced splicing",

cancelForceIframe: "Cancel forced splicing",

Configure: "Open the configuration page",

firstUpdate: "Click here to initialize the rules",

Update: "Update online rules",

Click2update: "Click to update the rules immediately",

loadNow: "turn the page now",

loadConfirm: "How many pages do you want to turn? 0 is uninterrupted),"

noNext: "No next page found, please create a new rule",

passSec: "Updated before #t# seconds",

passMin: "Updated #t# minutes ago",

passHour: "Updated before #t#",

passDay: "Updated on #t# days ago",
...
beginUpdate: "Updating, please be patient and do not close the page",

customUrls: "Import Pagetual or AutoPagerize rule url, line by line",

customRules: "Enter the custom rules in the format of [Oriental Yong Page Machine] <a href='#t#'>Contribution Rules</a>",

Save: "Save settings",

loadingText: "Girls pray...",

Opacity: "opaque value",

opacityPlaceholder: "0: Hide the divider",

hideBar: "Hidden paging partition",

hideBarButNoStop: "Hide but don't stop",

dbClick2Stop: "Double-click in the blank space to pause and turn the page",

sortTitle: "The sorting will take effect after the next update of the rules",

autoRun: "Automatically enable, otherwise it is whitelist mode",

autoLoadNum: "Automatically load the specified number of pages",

turnRate: "Start turning the page when it is twice the height of the page at the end of the page [X]",

inputPageNum: "Enter page number to jump",

enableHistory: "Write history after turning the page",

enableHistoryAfterInsert: "Write the history immediately after splicing, otherwise write the line after browsing",

contentVisibility: "Automatically switch contentVisibility to improve rendering performance",

initRun: "Try to turn the page immediately after opening the page, otherwise scroll to the end of the page and then turn the page",

Preload: "Pre-read the next page before turning the page to speed up browsing",

click2ImportRule: "Click below to add a special rule library and wait for the update to be successful:",

forceAllBody: "Do you want to splice the whole page?"

openInNewTab: "Open the content of the splicing page on the new page",

importSucc: "Import successfully",

Import: "import",

editCurrent: "Edit the rules of this site",

editBlacklist: "Edit blacklist URL, line by line, support? * Wildcard and regularity",

upBtnImg: "Back to the top icon",

downBtnImg: "Go to the end of the page icon",

sideControllerIcon: "sidebar icon",

loadingTextTitle: "Loading Chinese text",
...
pageElementCss: "Style of the main frame of the page",

customCss: "Custom css",

firstAlert: "You haven't imported the rule library yet, please select the appropriate rule library to import",

Picker: "Oriental permanent page machine main element grabber",

closePicker: "Turn off the Oriental permanent page machine grabper",

pickerPlaceholder: "Element selector, no idea, it is recommended to leave it blank",

pickerCheck: "Check the selector you edited and copy",

switchSelector: "Click to switch elements",

gotoEdit: "Use the current selector to go to the editing rules",

manualMode: "Disable splicing, manually turn the page with the right arrow key, and use the left arrow key to return",

clickMode: "Disable splicing, automatically click the next page when scrolling to the end of the page",

pageBarMenu: "Click the pop-up menu in the middle of the separator",

nextSwitch: "Switch other page numbers",

arrowToScroll: "Left arrow key to scroll to the previous page, right arrow key to scroll to the next page",

sideController: "Show the page turning control bar on the side",

hideLoadingIcon: "Hidden loading animation",

hideBarArrow: "Hide the divider positioning arrow",

Duplicate: "Repeat installation of the permanent page machine was detected, please delete the permanent page machine in other script managers!",

forceStateIframe: "Embed the whole page with iframe",

forceStateDynamic: "Take it out after loading dynamic content through iframe",

forceStateDisable: "Disable on this site",

autoScrollRate: "Scroll speed (1~1000),"

disableAutoScroll: "Stop automatic scrolling",

enableAutoScroll: "Turn on automatic scrolling",

toggleAutoScroll: "Auto Scroll Switch",
...
errorRulesMustBeArray: "The rules must be in array form!",

errorJson: "There is an error in the JSON format, please check again!",

editSuccess: "Edited successfully",

errorWrongUrl: "URL error, please check again!",

errorAlreadyExists: "It already exists!",

settingsSaved: "The settings have been saved and will take effect after refreshing",

Iframe: "Forced splicing",

Dynamic: "dynamic loading",

reloadPage: "The editing is complete, do you want to refresh the page immediately?"

Copied: "Copyed",

noValidContent: "No valid content was detected, click to view",

outOfDate: "The script is outdated, please update to the latest version in time!"

hideBarTips: "Hidden paging partition, immersive experience",

setConfigPage: "Set the current page as the default configuration page",

Wedata2github: "Change the wedata address to the mirror address in the github repository",

addOtherProp: "Add rule attributes",

addNextSelector: "Add selector content as nextLink",

addPageSelector: "Add selector content as pageElement",

propName: "Enter the rule attribute name",

propValue: "Enter the rule attribute value",

customFirst: "Ignore cache for local custom rules",

rulesExample: "Detailed explanation of custom rules"
...
Update: "Update the rules in the stream",

Click2update: "Click to update the rules immediately",

loadNow: "Flip the page now",

loadConfirm: "How many pages do you want to turn? 0 is uninterrupted),"

noNext: "No next page found, please create new rules",
...
customUrls: "Introduce Pagetual or AutoPagerize rule url, line by line",

customRules: "Enter the custom rules of the [Oriental Permanent Page Machine] format <a href='#t#'>Contribution Rules</a>",

Save: "Storage Settings",

loadingText: "Girls in prayer...",

Opacity: "opaque value",

opacityPlaceholder: "0: Hide the divider",

hideBar: "Hide the paging partition",

hideBarButNoStop: "Hide but don't stop",

dbClick2Stop: "Double-click to pause the page in the blank space",

sortTitle: "The sorting will take effect after the next update of the rules",

autoRun: "Automatically activated, otherwise it is whitelist mode",

autoLoadNum: "Automatically load the specified number of pages",

turnRate: "When it is twice the height of the page at the end of the page [X], start to turn the page",

inputPageNum: "Enter page code to jump",

enableHistory: "Write the history after turning the page",

enableHistoryAfterInsert: "Write the history immediately after splicing, otherwise write it after browsing",

contentVisibility: "Automatically switch contentVisibility to improve rendering performance",

initRun: "Try to turn the page immediately after opening the page, otherwise scroll to the end of the page and then turn the page",

Preload: "Read the next page before turning the page to speed up browsing",
...
editBlacklist: "Edit blacklist web addresses, line by line, support? * wildcard and regular",

upBtnImg: "Back to the top icon",

downBtnImg: "Go to the header icon",

sideControllerIcon: "side bar icon",

loadingTextTitle: "Add Chinese text",
...
firstAlert: "You haven't imported the rule library yet, please choose the appropriate rule library to import",

Picker: "Oriental permanent page machine main element grabber",

closePicker: "Close the Dongfang Yong Page Machine Grabper",
...
manualMode: "Disable splicing, manually use the right direction key to turn the page, left direction key to return",

clickMode: "Disable splicing, automatically click on the next page when scrolling to the end of the page",

pageBarMenu: "Click on the middle of the divider to pop up the menu",

nextSwitch: "Switch to other page numbers",

arrowToScroll: "Left direction key to the previous page, right direction key to the next page",

sideController: "Show the page-turn control bar on the side",

hideLoadingIcon: "Hide loading animation",

hideBarArrow: "Hide the divider positioning arrow",

Duplicate: "The duplicate installation of the permanent page machine has been detected, please delete the permanent page machine in other script managers!",
...
autoScrollRate: "Rolling speed (1~1000),"

disableAutoScroll: "Stop automatic scrolling",

enableAutoScroll: "Turn on automatic scrolling",

toggleAutoScroll: "Automatic scrolling switch",
...
errorRulesMustBeArray: "The rules must be in the form of an array!",

errorJson: "The JSON format is wrong, please check again!",
...
settingsSaved: "Settings have been saved and will take effect after refreshing",

Iframe: "Forced splicing",

Dynamic: "dynamic loading",

reloadPage: "Edit completed, do you want to refresh the page immediately?"

Copied: "Reprinted",

noValidContent: "No valid content detected, click to view",

outOfDate: "The script is out of date, please update to the latest version in time!"

hideBarTips: "Hide the paging partition, immersive experience",
...
propValue: "Input rule attribute value",

customFirst: "Ignore buffering for local custom rules",
...
passSec: "#t#Update in seconds",

passMin: "#t# updated before",

passHour: "#t#Update before time",

passDay: "#t#Updated a day ago",
...
contentVisibility: "contentVisibility を自動的に switchingてレンダリング パフォーマンスを向上させる",
...
switchSelector: "クリックして要素を switchingます",
...
nextSwitch: "次のページに switching",

arrowToScroll: "左矢印キーで前へ、右矢印キーで次へ",

sideController: "サイドバーにページング コントロールバーを表示する",
...
disableAutoScroll: "Automatic Scrollを停止し will",

EnableAutoScroll: "自動スクロールを有効にする",

toggleAutoScroll: "自動スクロールの switching",
...
customRules: "Введите пользовательские правила в формате Pagetual. <a href='#t#'>Улучшить Правила</a>",
...
turnRate: "Подгрузить страницу, когда она будет в 【X】 раз больше высоты

inputPageNum: "Введите номер страницы для перехода",

enableHistory: "Записать историю после переключения страниц",

enableHistoryAfterInsert: "Записать запись истории сразу после вставки, иначе записать Ра",

contentVisibility: "Автоматически переключать contentVisibility для повышения производительно Деринга",
...
manualMode: "Отключить автоматическую загрузку страниц. Загружать вручную с помощью стрелки вправо (или вызова событи

clickMode: "Отключить \"сшивание\" страниц. При прокрутке до конца автоматически переходить на следующую стра
...
setConfigPage: "Установить текущую страницу в качестве страницы конфигурации
...
manualMode: "Disable splicing, manually turn pages with the right arrow keys (or dispatch event 'pag Etual.next')",

clickMode: "Disable splicing, automatically click the next page when scrolling to the end of the pag E",
...
Var _GM_xmlhttpRequest, _GM_registerMenuCommand, _GM_notification, _GM_addStyle, _GM_openInTab, _GM_ Info, _GM_setClipboard;
...
Const _unsafeWindow = (typeof unsafeWindow == 'undefined') ? Window : unsafeWindow;//Compatible with ios userscripts
...
Const nextTextReg1 = new RegExp("\u005e\u7ffb\u003f\u005b\u4e0b\u540e\u5f8c\u6b21\u005d\u005b\u4e00\ U30fc\u0031\u005d\u003f\u005b\u9875\u9801\u5f20\u5f35\u005d\u007c\u005e\u006e\u0065\u0078\u0074\u005 B\u0020\u005f\u002d\u005d\u003f\u0070\u0061\u0067\u0065\u005c\u0073\u002a\u005b\u203a\u003e\u2192\u0 0bb\u005d\u003f\u0024\u007c\u6b21\u306e\u30da\u30fc\u30b8\u007c\u005e\u6b21\u3078\u003f\u0024\u007cВ Перед", "i");

Const nextTextReg2 = new RegExp("\u005e\u0028\u005b\u4e0b\u540e\u5f8c\u6b21\u005d\u005b\u4e00\u30fc\ U0031\u005d\u003f\u005b\u7ae0\u8bdd\u8a71\u82\u7bc0\u4e2a\u500b\u5e45\u005d\u007c\u006e\u0065\u007 8\u0074\u002e\u003f\u0063\u0068\u0061\u0070\u0074\u0065\u0072\u0029\u0028\u005b\u003a\uff1a\u005c\u0 05c\u002d\u005f\u2014\u0020\u005c\u005c\u002e\u3002\u003e\u0023\u00b7\u005c\u005c\u005b\u3010\u3001\ Uff08\u005c\u005c\u0028\u002f\u002c\uff0c\uff1b\u003b\u005d\u007c\u0024\u0029", "i");

Const lazyImgAttr = ["data-lazy-src", "data-lazy", "data-url", "data-orig-file", "zoomfile", "file", "Original", "load-src", "imgsrc", "real_src", "src2", "origin-src", "data-lazyload", "data-lazyload -Src", "data-lazy-load-src", "data-ks-lazyload", "data-ks-lazyload-custom", "data-src", "data-defer- Src", "data-actualsrc", "data-cover", "data-original", "data-thumb", "data-imageurl", "data-placehol Der", "lazysrc"];
...
//Google id class is random. Baidu is even more excessive. The order of style script is random.
...
If (! /^IMG$/i.test(curNode.nodeName) && curNode.querySelector('img') == null && /^\s*$/.test(curNode.inne rText)) continue;
...
If (curMaxEle && curMaxEle.offsetParent == curNode.offsetParent && curMaxEle.offsetTop == curNode.of fsetTop) {
...
Let video = targetEle.querySelector("video,iframe[id*=play],[id*=play]>iframe,iframe[src*=player],if Rame[src*=m3u8]");
...
Let canSave = false;// find that the page number selector does not match other pages, or don't save it.
...
! /^\s*([up, beginning and end]|previous)/i.test(nexts[i].innerText.trim())) {
...
body.querySelector("div.wp-pagenavi>span.current+a,div.page-nav>span.current+a,div.article-paging>sp An+a") ||
...
If (/^\d+$/.test(aTag.innerText.trim()) && /^\d+$/.test(prevEle.innerText.trim()) && parseInt(aTag.i nnerText) == parseInt(prevEle.innerText) + 1) {
...
Let targetUrl = await ((typeof _unsafeWindow.pagetualNextLinkByJs == 'undefined') ? New AsyncFunction("doc", '"use strict";' + this.curSiteRule.nextLinkByJs) : _unsafeWindow.pagetualNe xtLinkByJs)(doc);
...
Let targetUrl = this.curUrl.replace(new RegExp(this.curSiteRule.nextLinkByUrl[0], "i"), this.curSite Rule.nextLinkByUrl[1]);
...
If (nextLink && (this.curSiteRule.action == 0 || this.curSiteRule.action == 1 || this.curSiteRule.ac Tion == 2)) {
...
If (parent.classList.contains("noClick") || parent.classList.contains("no-pages") || parent.classLis T.contains("disabled")) {
...
Let needUrl = (this.curSiteRule.action == 0 || this.curSiteRule.action == 1 || this.curSiteRule.acti On == 2);
...
If (tempUrl ! = "#" && (this.compareUrl(tempUrl, this.initUrl) || this.compareUrl(tempUrl, this.curUrl) || this.co mpareUrl(tempUrl, this.curUrl + "#") || this.compareUrl(tempUrl, this.oldUrl) || this.compareUrl(tem pUrl, this.oldUrl + "#"))) {
...
Let typeObject = ! typeArray && (this.curSiteRule.stopSign.include || this.curSiteRule.stopSign.exclude || this.curSite Rule.stopSign.pageNum);
...
Let stopSign = ((typeof _unsafeWindow.stopSign == 'undefined') ? Function("doc", "nextLink", '"use strict";' + this.curSiteRule.stopSign) : _unsafeWindow.stopSign)(d Oc, nextLink);
...
overrideMimeType: 'text/html;charset=' + (document.characterSet || document.charset || document.inpu tEncoding),
...
"Content-Type": (postParams ? "Application/x-www-form-urlencoded" : "text/html") + ";charset=" + (document.characterSet || documen T.charset || document.inputEncoding),
...
// If it is randomly matched again, it will not cache wedata, or only consider the cache of wedata after finding the local rules.
...
((Typeof _unsafeWindow.pagetualInit == 'undefined') ? New AsyncFunction('doc', 'win', 'iframe', 'click', 'enter', 'input', 'use strict";' + code) : _unsa feWindow.pagetualInit)(null, null, null, sel => {clickAction(sel, document)}, sel => {enterAction(se L, document)}, (sel, v) =>{inputAction(sel, v, document)});
...
<div id="pagetual-sideController-move"><svg width="30" height="30" style="border-radius: 15px;displa Y: initial;position: relative;cursor: pointer;margin: 0;width: 30px;height: 30px;vertical-align: mid Dle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3 .Org/2000/svg"><path d="M296 440c-44.1 0-80 35.9-80 80s35.9 80 80 80 80-35.9 80-80-35.9-80-80z" f Ill="#604b4a"></path><path d="M960 512c0-247-201-448-448-448S64 265 64 512c0 1.8 0.1 3.5 0.1 5.3 0 0 .9-0.1 1.8-0.1 2.7h0.2C68.5 763.3 267.7 960 512 960c236.2 0 430.1-183.7 446.7-415.7 0.1-0.8 0.1-1.6 0.2-2.3 0.4-4.6 0.5-9.3 0.7-13.9 0.1-2.7 0.4-5.3 0.4-8h-0.2c0-2.8 0.2-5.4 0.2-8.1z m-152 8c0 44.1-35 .9 80-80 80s-80-35.9-80-80 35.9-80 80-80 80 35.9 80 80zM512 928C284.4 928 99 744.3 96.1 517.3 97.6 4 08.3 186.6 320 296 320c110.3 0 200 89.7 200 200 0 127.9 104.1 232 232 232 62.9 0 119.9-25.2 161.7-66 -66 142.7-210.4 242-377.7 242z" fill="#604b4a"></path></svg><div id="pagetual-sideController-pagenum "></div></div>
...
window.scrollTo({ top: scrollTop - (window.innerHeight || document.documentElement.clientHeight), be Havior: 'smooth'});
...
<path d="M512 128c212 0 384 172 384 384s-172 384-384 384-384-172-384-384 172-384 384-384m0-64C264.8 64 64 264.8 64 512s200.8 448 448 448-200.8 448-448S759.2 64 512 64z m238.4 254.4l-45.6-45.6L512 467.2 318.4 273.6l-45.6 45.6L467.2 512 273.6 705.6l45.6 45.6L512 557.6l193.6 193.6 45.6-45.6L557.6 5 12l192.8-193.6z" p-id="2755">
...
<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M512 128a384 384 0 1 0 0 768 384 384 0 0 0 0 0-768z m0-85.333333c259.2 0 469.333333 210.133333 469.333333 469.33333 3s-210.133333 469.333333-469.333333 469.333333S42.666667 771.2 42.666667 512 252.8 42.666667 512 42. 666667zM696.149333 298.666667L768 349.866667 471.594667 725.333333 256 571.733333l53.888-68.266666 1 43.744 102.4z" fill="#604b4a"></path></svg>
...
<svg viewBox="0 0 1024 1024" style="color: orangered;fill: orangered;" version="1.1" xmlns="http://w Ww.w3.org/2000/svg">

<path d="M775.84 392.768l-155.2-172.352L160.768 643.264l-38.368 187.936 190.56-12.832zM929.952 229.9 52l-131.2-150.944-0.288-0.32a16 16 0 0 0 0-22.592-0.96l-131.168 120.576 155.168 172.352 128.832-118.46 4a15.936 15.936 0 0 0 1.248-22.24zM96 896h832v64H96z">
...
<button id="nextSwitch" class="command" title="${i18n("nextSwitch")}" type="button">${i18n("nextSwit Ch")}</button>

<button id="loadNow" class="command" title="${i18n("loadNow")}" type="button">${i18n("loadNow")}</bu Tton>

<button id="autoScroll" class="command" title="${i18n("toggleAutoScroll")}" type="button"></button>

<div>

<textarea style="display: none;" class="tempRule" spellcheck="false" placeholder="{Rule object}" tit le="Rule for current site"></textarea>

<button id="showDetail" title="" type="button">

<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M511.1 63.7c- 247.4 0-448 200.6-448 448s200.6 448 448 448-200.6 448-448-200.6-448-448-448z m281.2 374.5L535.6 694.9c-12.5 12.5-32.8 12.5-45.3 0l-255.8-256c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l210.7 210. 7c12.5 12.5 32.8 12.5 45.3 0l211.4-211.4c12.5-12.5 32.8-12.5 45.3 0 12.3 12.5 12.3 32.8-0.2 45.3z" f Ill="orangered"></path></svg>
...
<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M704 128H192c -35.2 0-64 28.8-64 64v640c0 35.2 28.8 64 64 64h640c35.2 0 64-28.8 64-64V320L704 128zM256 256h320v128 H256V256z m256 512c-70.4 0-128-57.6-128-128s57.6-128 128-128 128 57.6 128 128-57.6 128-128 128z" fil L="orangered"></path></svg>
...
Let forceStateIframe = frame.querySelector("#forceStateIframe");//forceState 1 disable 2 strong embed 3 dynamics
...
this.tempRule.value = this.tempRule.value.slice(0, pos) + "➡️" + this.tempRule.value[pos] + "⬅️" + t his.tempRule.value.slice(pos + 1);
...
If (ruleParser.curSiteRule.nextLink && Array && Array.isArray && Array.isArray(ruleParser.curSiteRul e.nextLink)) {
...
Let enableHistoryAfterInsertInput = createCheckbox(i18n("enableHistoryAfterInsert"), rulesData.enabl eHistoryAfterInsert === true);
...
customRulesTitle.innerHTML = i18n("customRules", /tree/.test(location.href) ? Location.href.replace('tree', 'edit').replace(/\/$/, '') + '/pagetualRules.json' : 'https://github.c om/hoothin/UserScripts/edit/master/Pagetual/pagetualRules.json');
...
Url: data && data.wedata2github ? 'https://hoothin.github.io/UserScripts/Pagetual/items_all.json' : 'http://wedata.net/databases/AutoP Agerize/items_all.json',
...
Let upBtnImg = rulesData.upBtnImg, downBtnImg = rulesData.downBtnImg, _sideControllerIcon = rulesDat a.sideControllerIcon;
...
// If there is only 1, I'm afraid it's not a picture.
...
Font-family: "Bronware", -apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto",
...
pageBarStyle = `overflow: visible;text-indent: initial;vertical-align: super;line-height:1;opacity:$ {rulesData.opacity};display:${rulesData.opacity == 0 ? "None" : "inline-flex"};padding:0;font-size: 30px;visibility: visible; position: relative; width: au To; max-width: 100vw; height: 30px; float: none; clear: both; margin: 5px auto; text-align: center;j Ustify-content: center;box-sizing: content-box;${rulesData.opacity == 1 ? "Border-top: 1px solid rgb(80, 80, 80);" : "box-shadow: 0px 0px 10px 0px #000000aa;border-radius: 20 Px;background-color: rgb(240 240 240 / 80%);"}`;
...
loadingDiv.style.cssText = "text-indent: initial;cy: initial;d: initial;dominant-baseline: initial;e Mpty-cells: initial;fill: initial;fill-opacity: initial;fill-rule: initial;filter: initial;flex: ini Tial;flex-flow: initial;float: initial;flood-color: initial;flood-opacity: initial;grid: initial;gri D-area: initial;height: initial;hyphens: initial;image-orientation: initial;image-rendering: initial ;Inline-size: initial;inset-block: initial;inset-inline: initial;isolation: initial;letter-spacing: Initial;lighting-color: initial;line-break: initial;list-style: initial;margin-block: initial;margin : 0px auto;margin-inline: initial;marker: initial;mask: initial;mask-type: initial;max-block-size: i Nitial;max-height: initial;max-inline-size: initial;max-width: initial;min-block-size: initial;min-h Eight: initial;min-inline-size: initial;min-width: initial;mix-blend-mode: initial;object-fit: initi Al;object-position: initial;offset: initial;opacity: initial;order: initial;origin-trial-test-proper Ty: initial;orphans: initial;outline: initial;outline-offset: initial;overflow-anchor: initial;overf Low-clip-margin: initial;overflow-wrap: initial;overflow: initial;overscroll-behavior-block: initial ;Overscroll-behavior-inline: initial;overscroll-behavior: initial;padding-block: initial;padding: in Itial;padding-inline: initial;page: initial;page-orientation: initial;paint-order: initial;perspecti Ve: initial;perspective-origin: initial;pointer-events: initial;position: initial;quotes: initial;r: Initial;resize: initial;ruby-position: initial;rx: initial;ry: initial;scroll-behavior: initial;scr Oll-margin-block: initial;scroll-margin: initial;scroll-margin-inline: initial;scroll-padding-block: Initial;scroll-padding: initial;scroll-padding-inline: initial;scroll-snap-align: initial;scroll-sn Ap-stop: initial;scroll-snap-type: initial;scrollbar-gutter: initial;shape-image-threshold: initial; Shape-margin: initial;shape-outside: initial;shape-rendering: initial;size: initial;speak: initial;s Top-color: initial;stop-opacity: initial;stroke: initial;stroke-dasharray: initial;stroke-dashoffset : initial;stroke-linecap: initial;stroke-linejoin: initial;stroke-miterlimit: initial;stroke-opacity : initial;stroke-width: initial;tab-size: initial;table-layout: initial;text-align: initial;text-ali Gn-last: initial;text-anchor: initial;text-combine-upright: initial;text-decoration: initial;text-de Coration-skip-ink: initial;text-indent: initial;text-overflow: initial;text-shadow: initial;text-siz E-adjust: initial;text-transform: initial;text-underline-offset: initial;text-underline-position: in Itial;touch-action: initial;transform: initial;transform-box: initial;transform-origin: initial;tran Sform-style: initial;transition: initial;user-select: initial;vector-effect: initial;vertical-align: Initial;visibility: initial;border-spacing: initial;-webkit-border-image: initial;-webkit-box-align : initial;-webkit-box-decoration-break: initial;-webkit-box-direction: initial;-webkit-box-flex: ini Tial;-webkit-box-ordinal-group: initial;-webkit-box-orient: initial;-webkit-box-pack: initial;-webki T-box-reflect: initial;-webkit-highlight: initial;-webkit-hyphenate-character: initial;-webkit-line- Break: initial;-webkit-line-clamp: initial;-webkit-mask-box-image: initial;-webkit-mask: initial;-we Bkit-mask-composite: initial;-webkit-perspective-origin-x: initial;-webkit-perspective-origin-y: ini Tial;-webkit-print-color-adjust: initial;-webkit-rtl-ordering: initial;-webkit-ruby-position: initia L;-webkit-tap-highlight-color: initial;-webkit-text-combine: initial;-webkit-text-decorations-in-eff Ect: initial;-webkit-text-emphasis: initial;-webkit-text-emphasis-position: initial;-webkit-text-fil L-color: initial;-webkit-text-security: initial;-webkit-text-stroke: initial;-webkit-transform-origi N-x: initial;-webkit-transform-origin-y: initial;-webkit-transform-origin-z: initial;-webkit-user-dr Ag: initial;-webkit-user-modify: initial;white-space: initial;widows: initial;width: initial;will-ch Ange: initial;word-break: initial;word-spacing: initial;x: initial;y: initial;z-index: 2147483647;";

Const loadingCSS = `text-indent: unset; display: block; position: initial; margin: auto auto 5px aut O; shape-rendering: auto; vertical-align: middle; visibility: visible; width: initial; height: initi Al; text-align: center; color: #6e6e6e; flex: 0;`;

Function setLoadingDiv(loadingText) {

loadingDiv.innerHTML = createHTML(`<p class="pagetual_loading_text" style="${loadingCSS}display: inl Ine-block;width: 100%;">${loadingText}</p>${rulesData.hideLoadingIcon ? "" : `<div class="pagetual_loading"><svg width="50" height="50" style="position:relative;cursor: poi Nter;width: 50px;height: 50px;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox=" 0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M296 440c-44.1 0-80 35.9-80 80s35.9 80 80 80 80-35.9 80-80-35.9-80-80-80z" fill="#6e6e"></path><path d="M960 512c0-247-201-44 8-448-448S64 265 64 512c0 1.8 0.1 3.5 0.1 5.3 0 0.9-0.1 1.8-0.1 2.7h0.2C68.5 763.3 267.7 960 512 960 C236.2 0 430.1-183.7 446.7-415.7 0.1-0.8 0.1-1.6 0.2-2.3 0.4-4.6 0.5-9.3 0.7-13.9 0.1-2.7 0.4-5.3 0. 4-8h-0.2c0-2.8 0.2-5.4 0.2-8.1z m-152 8c0 44.1-35.9 80-80 80s-80-35.9-80-80 35.9-80 80-80 80 35.9 80 80zM512 928C284.4 928 99 744.3 96.1 517.3 97.6 408.3 186.6 320 296 320c110.3 0 200 89.7 200 200 0 1 27.9 104.1 232 232 232 62.9 0 119.9-25.2 161.7-66-66 142.7-210.4 242-377.7 242z" fill="#6e6e6e"></pa Th></svg></div>`}`);

}

Var upSvg = `<svg width="30" height="30" class="upSvg pagetual" style="display:initial;position:rela Tive;cursor: pointer;margin: 0 8px;width: 30px;height: 30px;vertical-align: baseline;fill: currentCo Lor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><pat H d="M296 440c-44.1 0-80 35.9-80 80s35.9 80 80 80 80 80-35.9 80-80-35.9-80-80z" fill="#604b4a"></pat H><path d="M960 512c0-247-201-448-448-448S64 265 64 512c0 1.8 0.1 3.5 0.1 5.3 0 0.9-0.1 1.8-0.1 2.7h 0.2C68.5 763.3 267.7 960 512 960c236.2 0 430.1-183.7 446.7-415.7 0.1-0.8 0.1-1.6 0.2-2.3 0.4-4.6 0.5 -9.3 0.7-13.9 0.1-2.7 0.4-5.3 0.4-8h-0.2c0-2.8 0.2-5.4 0.2-8.1z m-152 8c0 44.1-35.9 80-80 80s-80-35. 9-80-80 35.9-80 80-80 80 35.9 80 80zM512 928C284.4 928 99 744.3 96.1 517.3 97.6 408.3 186.6 320 296 320c110.3 0 200 89.7 200 200 0 127.9 104.1 232 232 232 62.9 0 119.9-25.2 161.7-66-66 142.7-210.4 242 -377.7 242z" fill="#604b4a"></path></svg>`;
...
Var downSvg = `<svg width="30" height="30" class="downSvg pagetual" style="display:initial;position: Relative;cursor: pointer;margin: 0 8px;width: 30px;height: 30px;vertical-align: baseline;fill: curre ntColor;overflow: hidden;transform: rotate(180deg);" viewBox="0 0 1024 1024" version="1.1" xmlns="ht Tp://www.w3.org/2000/svg"><path d="M296 440c-44.1 0-80 35.9-80 80s35.9 80 80 80 80-35.9 80-80-35.9-8 0-80-80z" fill="#604b4a"></path><path d="M960 512c0-247-201-448-448-448S64 265 64 512c0 1.8 0.1 3.5 0.1 5.3 0 0.9-0.1 1.8-0.1 2.7h0.2C68.5 763.3 267.7 960 512 960c236.2 0 430.1-183.7 446.7-415.7 0.1-0 .8 0.1-1.6 0.2-2.3 0.4-4.6 0.5-9.3 0.7-13.9 0.1-2.7 0.4-5.3 0.4-8h-0.2c0-2.8 0.2-5.4 0.2-8.1z m-152 8c0 44.1-35.9 80-80 80s-80-35.9-80-80 35.9-80 80-80 80 35.9 80 80zM512 928C284.4 928 99 744.3 96.1 5 17.3 97.6 408.3 186.6 320 296 320c110.3 0 200 89.7 200 200 0 127.9 104.1 232 232 232 62.9 0 119.9-25 .2 161.7-66-66 142.7-210.4 242-377.7 242z" fill="#604b4a"></path></svg>`;

Var downSvgCSS = `text-align: center;display: initial;position: relative;cursor: pointer;margin: 0 8 Px;width: 30px;height: 30px;vertical-align: baseline;fill: currentColor;overflow: hidden;transform: Rotate(180deg);`;

Const initStyle = `text-indent: initial;display: contents;right: unset;left: unset;top: unset;bottom : unset;inset: unset;clear: both;cy: initial;d: initial;dominant-baseline: initial;empty-cells: init Ial;fill: initial;fill-opacity: initial;fill-rule: initial;filter: initial;flex: initial;flex-flow: Initial;float: initial;flood-color: initial;flood-opacity: initial;grid: initial;grid-area: initial; Height: initial;hyphens: initial;image-orientation: initial;image-rendering: initial;inline-size: in Itial;inset-block: initial;inset-inline: initial;isolation: initial;letter-spacing: initial;lighting -Color: initial;line-break: initial;list-style: initial;margin-block: initial;margin: 0px 5px;margin -Inline: initial;marker: initial;mask: initial;mask-type: initial;max-block-size: initial;max-height : initial;max-inline-size: initial;max-width: initial;min-block-size: initial;min-height: initial;mi N-inline-size: initial;min-width: initial;mix-blend-mode: initial;object-fit: initial;object-positio N: initial;offset: initial;opacity: initial;order: initial;orphans: initial;outline: initial;outline -Offset: initial;overflow-anchor: initial;overflow-clip-margin: initial;overflow-wrap: initial;overf Low: initial;overscroll-behavior-block: initial;overscroll-behavior-inline: initial;overscroll-behav Ior: initial;padding-block: initial;padding: initial;padding-inline: initial;page: initial;page-orie Ntation: initial;paint-order: initial;perspective: initial;perspective-origin: initial;pointer-event S: initial;position: relative;quotes: initial;r: initial;resize: initial;ruby-position: initial;rx: Initial;ry: initial;scroll-behavior: initial;scroll-margin-block: initial;scroll-margin: initial;scr Oll-margin-inline: initial;scroll-padding-block: initial;scroll-padding: initial;scroll-padding-inli Ne: initial;scroll-snap-align: initial;scroll-snap-stop: initial;scroll-snap-type: initial;scrollbar -Gutter: initial;shape-image-threshold: initial;shape-margin: initial;shape-outside: initial;shape-r Endering: initial;size: initial;speak: initial;stop-color: initial;stop-opacity: initial;stroke: ini Tial;stroke-dasharray: initial;stroke-dashoffset: initial;stroke-linecap: initial;stroke-linejoin: i Nitial;stroke-miterlimit: initial;stroke-opacity: initial;stroke-width: initial;tab-size: initial;ta Ble-layout: initial;text-align: initial;text-align-last: initial;text-anchor: initial;text-combine-u Pright: initial;text-decoration: initial;text-decoration-skip-ink: initial;text-indent: initial;text -Overflow: initial;text-shadow: initial;text-size-adjust: initial;text-transform: initial;text-under Line-offset: initial;text-underline-position: initial;touch-action: initial;transform: initial;trans Form-box: initial;transform-origin: initial;transform-style: initial;transition: initial;user-select : initial;vector-effect: initial;vertical-align: initial;visibility: initial;border-spacing: initial ;-Webkit-border-image: initial;-webkit-box-align: initial;-webkit-box-decoration-break: initial;-web Kit-box-direction: initial;-webkit-box-flex: initial;-webkit-box-ordinal-group: initial;-webkit-box- Orient: initial;-webkit-box-pack: initial;-webkit-box-reflect: initial;-webkit-highlight: initial;-w Ebkit-hyphenate-character: initial;-webkit-line-break: initial;-webkit-line-clamp: initial;-webkit-m Ask-box-image: initial;-webkit-mask: initial;-webkit-mask-composite: initial;-webkit-perspective-ori Gin-x: initial;-webkit-perspective-origin-y: initial;-webkit-print-color-adjust: initial;-webkit-rtl -Ordering: initial;-webkit-ruby-position: initial;-webkit-tap-highlight-color: initial;-webkit-text- Combine: initial;-webkit-text-decorations-in-effect: initial;-webkit-text-emphasis: initial;-webkit- Text-emphasis-position: initial;-webkit-text-fill-color: initial;-webkit-text-security: initial;-web Kit-text-stroke: initial;-webkit-transform-origin-x: initial;-webkit-transform-origin-y: initial;-we Bkit-transform-origin-z: initial;-webkit-user-drag: initial;-webkit-user-modify: initial;white-space : initial;widows: initial;width: initial;will-change: initial;word-break: initial;word-spacing: init Ial;x: initial;y: initial;`;

Const pageTextStyle = `opacity: 1! Important;text-indent: initial;padding: unset;border: none;background: unset! Important;line-height: 30px;text-decoration: none;user-select: none;visibility: visible;position: in Itial;width: auto;max-width: 80%; white-space: nowrap; text-overflow: ellipsis;overflow: hidden;heig Ht: auto;float: none;clear: both;margin: 0px;text-align: center;display: inline-block;font-weight: b Old;font-style: normal;font-size: 16px;letter-spacing: initial;vertical-align: top;color: rgb(85, 85 , 95)! Important;`;
...
Var isPause = false, isHideBar = false, isLoading = false, curPage = 1, forceState = 0, autoScroll = 0, autoScrollInterval, bottomGap = 1000, autoLoadNum = -1, nextIndex = 0, stopScroll = false, click Mode = false;
...
[].forEach.call(getBody(document).querySelectorAll(.pagetual_pageBar,#pagetual-sideController"), ba R => {
...
Let checkLoadMore, scrollHandler, clickToResetHandler, dblclickHandler, keydownHandler, hashchangeHa Ndler, manualModeKeyHandler, pagetualNextHandler, keyupHandler;
...
Const loadmoreReg = /^\s*((click)? Load more | (click)? Load more|load\s*more|More read込む)[....]*\s*$/i;
...
While (example && (/^(SCRIPT|STYLE)$/i.test(example.nodeName) || example.className == "pagetual_page Bar")) {
...
inLi = /^LI$/i.test(example.nodeName) || (example.nextElementSibling && /^LI$/i.test(example.nextEle mentSibling.nodeName));
...
getBody(document).removeEventListener('touchstart', touchBodyHandler, { passive: false, capture: fal Se });
...
preBtn.style.cssText = "display: none;text-align: center;right: unset; float: left; width: 40px; bac Kground: rgba(240, 240, 240, 0.8); position: absolute; z-index: 9999999; box-shadow: rgb(0 0 0 / 50% ) 0px -5px 5px; border-radius: 20px 20px 0 0; margin-top: -30px; ";
...
nextBtn.style.cssText = "display: none;text-align: center;right: unset; float: left; width: 40px; ba Ckground: rgba(240, 240, 240, 0.8); position: absolute; z-index: 9999999; box-shadow: rgb(0 0 0 / 50 %) 0px 5px 5px; border-radius: 0 0 20px 20px; margin-top: 30px; ";
...
pageBar.style.width = parentWidth - parseInt(parentStyle.paddingLeft) - parseInt(parentStyle.padding Right) - 10 + "px";
...
Var nativeInputValueSetter = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, "val Ue").set;
...
Let orgPage = null, preContent = null, iframeDoc, checkTimes = 0, loadmoreBtn, pageEle, nextLink, lo admoreEnd = false, waitTimes = 80, changed = false;
...
iframeDoc = emuIframe.contentDocument || (emuIframe.contentWindow && emuIframe.contentWindow.documen T);
...
Let curIframe = document.createElement('iframe'), iframeDoc, pageElement = null, isloaded = false, i nAction = true;
...
iframeDoc = curIframe.contentDocument || (curIframe.contentWindow && curIframe.contentWindow.documen T);
...
curIframe.style.cssText = 'display: block; visibility: visible; float: none; clear: both; width: 100 %; height: 0; background: initial; border: 0px; border-radius: 0px; margin: 0px; padding: 0px; z-ind Ex: 2147483647;content-visibility: auto;contain-intrinsic-size: auto 300px;';
...
New AsyncFunction('doc', 'win', 'iframe', 'click', 'enter', 'input', '"use strict";' + code)(iframeD Oc, curIframe.contentWindow, curIframe, sel => {clickAction(sel, iframeDoc)}, sel => {enterAction(se L, iframeDoc)}, (sel, v) =>{inputAction(sel, v, iframeDoc)});
...
Let isJs = ruleParser.curSiteRule.action == 3 || /^(javascript|#)/.test(nextLink.replace(location.hr Ef, ""));
