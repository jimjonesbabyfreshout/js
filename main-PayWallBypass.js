// ==UserScript==
// @name     main_PayWallBypass
// @namespace main_PayWallBypass
// ==/UserScript==
    ...
    [179],
    {
        ...
        310: function (e, t, r) {
            ...
            var T = function (e) {
                ...
                V = M.defaultLocale,
                X = U || "";
            (r.p = "".concat(X, "/_next/")), b.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: H || {} });
            var Q = _.getURL();
                                ...
                                value: function () {
                                    this.scrollToHash(),
                                        Z.isSsr &&
                                            ...
                                            (B ||
                                                (M.nextExport &&
                                                    (y.isDynamicRoute(Z.pathname) || location.search, 1)) ||
                                    ...
                                    switch ((e.prev = e.next)) {
                                        ...
                                        case 36:
                                            return (
                                                ...
                                                se((c = { App: ee, initial: !0, Component: oe, props: L, err: r })),
                                                e.abrupt("return", ie)
                                            );
                                        case 43:
                    ...
                    K.loadPage("/_error")
                        ...
                        .then(function (r) {
                            ...
                            return Promise.resolve(e.props ? e.props : _.loadGetInitialProps(t, u)).then(function (t) {
                                return ge(C({}, e, { err: n, Component: o, styleSheets: a, props: t }));
                            });
                        })
                );
            }
                                                    ...
                                                    switch ((t.prev = t.next)) {
                                                        ...
                                                        case 18:
                                                            if (
                                                                ...
                                                                this._inFlightRoute &&
                                                                    this.abortComponentLoad(this._inFlightRoute, _),
                                                                (a = S(
                                                                    x(E(a) ? O(a) : a, i.locale, this.defaultLocale),
                                                                )),
                                                        ...
                                                        case 40:
                                                            return (
                                                                (N = t.sent), (t.next = 43), s.getClientBuildManifest()
                                                            );
                                                        case 43:
                                                        ...
                                                        case 61:
                                                            if (((H = w(O(H), this.locale)), !d.isDynamicRoute(B))) {
                                                                t.next = 77;
                                                                break;
                                                            }
                                                            if (
                                                            ...
                                                            if (
                                                                !(
                                                                    (Q = Object.keys(z.groups).filter(function (e) {
                                                                        return !D[e];
                                                                    })).length > 0
                                                                )
                                                            ) {
                                                        ...
                                                        case 93:
                                                            if (
                                                                ((this.isPreview = !!ee.__N_PREVIEW), ee.notFound !== L)
                                                            ) {
                                                                t.next = 107;
                                                                break;
                                                            }
                                                        ...
                                                        case 104:
                                                            return (
                                                                (t.next = 106),
                                                                this.getRouteInfo(ce, ce, D, a, H, { shallow: !1 })
                                                            );
                                                        case 106:
                                                            Y = t.sent;
                                                        case 107:
                                                        ...
                                                        case 116:
                                                            ...
                                                            throw (e.events.emit("routeChangeError", Z, P, _), Z);
                                                        case 119:
                                                            return (
                                                        ...
                                                        case 124:
                                                            if (
                                                                ((t.prev = 124), (t.t2 = t.catch(78)), !t.t2.cancelled)
                                                            ) {
                                                                t.next = 128;
                                                                break;
                                                            }
                                                    ...
                                                    switch ((t.prev = t.next)) {
                                                        ...
                                                        case 28:
                                                            return (
                                                                ...
                                                                t.abrupt(
                                                                    "return",
                                                                    this.handleRouteInfoError(t.t1, o, a, i, u, !0),
                                                                )
                                                            );
                                                        case 31:
                                                        case "end":
                ...
                (t.default = function (e, t, r, n) {
                    ...
                    try {
                        var j = (v = y(t)).split("#"),
                            ...
                            R = k[0],
                            A = k[1];
                        (c.pathname = R), (c.hash = "".concat(A ? "#" : "").concat(A || "")), delete c.search;
                    } catch (C) {
                    ...
                    return (c.query = i(i({}, r), c.query)), { newUrl: v, parsedDestination: c };
                }),
                ...
                (t.default = function (e, t, r, o, a, p) {
                    for (
                        var d,
                            ...
                            m = u.removePathTrailingSlash(c.normalizeLocalePath(l.delBasePath(v.pathname), p).pathname),
                            y = function (r) {
                                ...
                                (e.getCLS = function (e, t) {
                                    ...
                                    (e.getLCP = function (e, t) {
                                        ...
                                        if (f) {
                                            ...
                                            var p = function () {
                                                P.has(o.id) ||
                                                    (f.takeRecords().map(l), f.disconnect(), P.add(o.id), r(!0));
                                            };
