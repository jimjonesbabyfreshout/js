// ==UserScript==
// @name       Ios_PayWallBypass
// @namespace  Ios_PayWallBypass
// ==/UserScript==
                ...
                return (0, l.jsxs)(
                    ...
                    i(
                        ...
                        {},
                        {
                            ...
                            children: [
                                (0, l.jsx)("path", {
                                    d: "M17.6535 73.5H17.9574L18.0974 73.2302L55.4438 1.23022L55.8226 0.5H55H39.7732H39.4709L39.3305 0.767712L1.55723 72.7677L1.17305 73.5H2H17.6535Z",
                                    fill: "#1A1A1A",
                                    stroke: "white",
                                }),
                                (0, l.jsx)("path", {
                                    d: "M40.6535 73.5H40.9574L41.0974 73.2302L78.4438 1.23022L78.8226 0.5H78H62.7732H62.4709L62.3305 0.767712L24.5572 72.7677L24.1731 73.5H25H40.6535Z",
                                    fill: "#5E5E5E",
                                    stroke: "white",
                                }),
                                (0, l.jsxs)("mask", {
            ...
            function c() {
                return (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsxs)(r.default, {
                            children: [
                                (0, i.jsx)("title", { children: "12ft | iOS" }),
                                (0, i.jsx)("meta", { name: "twitter:card", content: "summary_large_image" }),
                                (0, i.jsx)("meta", { name: "twitter:creator", content: "@thmsmlr" }),
                                (0, i.jsx)("meta", { property: "og:url", content: "https://12ft.io/ios" }),
                                (0, i.jsx)("meta", { property: "og:type", content: "website" }),
                                (0, i.jsx)("meta", { property: "og:title", content: "12ft \u2013\xa0Hop any paywall" }),
                                (0, i.jsx)("meta", {
                                    property: "og:description",
                                    content: "Hop the website paywalls on iOS",
                                }),
                                (0, i.jsx)("meta", {
                                    property: "og:image",
                                    content: "https://12ft.io/og-banner-ios.png",
                                }),
                            ],
                        }),
                        (0, i.jsx)("div", {
                            className: "bg-gray-50 overflow-hidden px-4 md:px-6",
                            children: (0, i.jsxs)("div", {
                                className: "pt-16 max-w-screen-md mx-auto flex flex-col md:flex-row md:space-x-12",
                                children: [
                                    (0, i.jsx)("div", {
                                        className: "w-1/2 hidden md:block",
                                        children: (0, i.jsx)("img", {
                                            className: "px-12 -mb-24 md:-mb-48",
                                            src: "/ios-remove-paywall-tight.png",
                                            alt: "",
                                        }),
                                    }),
                                    (0, i.jsxs)("div", {
                                        ...
                                        children: [
                                            (0, i.jsx)(l.default, {
                                                href: "/",
                                                children: (0, i.jsx)("a", {
                                                    children: (0, i.jsx)(n.Z, { className: "w-24 h-24 inline-block" }),
                                                }),
                                            }),
                                            (0, i.jsx)("h1", {
                                                className: "mt-12 text-5xl font-thin",
                                                children: "Hop the paywalls",
                                            }),
                                            (0, i.jsx)("h2", {
                                            ...
                                            (0, i.jsx)("a", {
                                                ...
                                                children: (0, i.jsxs)("div", {
                                                    className:
                                                        "mt-12 inline-flex items-center py-2 px-4 rounded-lg space-x-2 text-white hover:shadow-lg",
                        ...
                        (0, i.jsx)("div", {
                            className: "max-w-screen-md mx-auto px-4 md:px-6",
                            children: (0, i.jsxs)("div", {
                                className: "prose-lg",
                                children: [
                                    (0, i.jsx)("strong", {
                                        children: (0, i.jsx)("h2", { children: "Installation Guide" }),
                                    }),
                                    (0, i.jsxs)("div", {
                                        className: "md:flex items-start md:space-x-6",
                                        children: [
                                            (0, i.jsxs)("div", {
                                                children: [
                                                    (0, i.jsx)("h3", { children: "Step 1: Allow Untrusted Shortcuts" }),
                                                    (0, i.jsxs)("p", {
                                                        children: [
                                            ...
                                            (0, i.jsx)("img", {
                                                ...
                                                src: "/ios-untrusted-shortcuts.png",
                                                alt: "",
                                            }),
                                        ],
                                    }),
                                    ...
                                    (0, i.jsxs)("div", {
                                        ...
                                        children: [
                                            (0, i.jsx)("img", {
                                                ...
                                                src: "/ios-shortcuts.png",
                                                alt: "",
                                            }),
                                            (0, i.jsxs)("div", {
                                                children: [
                                                    (0, i.jsx)("h3", { children: "Step 2: Download the Shortcut" }),
                                                    (0, i.jsxs)("p", {
                                                        children: [
                                                            (0, i.jsx)("a", {
                                                                href: "/ios-shortcut",
                                    ...
                                    (0, i.jsxs)("div", {
                                        ...
                                        children: [
                                            (0, i.jsxs)("div", {
                                                children: [
                                                    (0, i.jsx)("h3", { children: "Step 3: Hop the Paywall" }),
                                                    (0, i.jsxs)("p", {
                                                        children: [
                                                            "In Safari or any other browser on your iPhone select the",
                                                            " ",
                                                            (0, i.jsx)("strong", { children: "Remove Paywall" }),
                                                            " shortcut from the",
                                                            " ",
                                                            (0, i.jsxs)("div", {
                                                                ...
                                                                children: [
                                                                    (0, i.jsxs)("svg", {
                                                                        className:
                                                                            "h-5 w-5 inline-block self-center mr-1",
                                                                        viewBox: "0 0 50 50",
                                                                        children: [
                                                                            (0, i.jsx)("path", {
                                                                                d: "M30.3 13.7L25 8.4l-5.3 5.3-1.4-1.4L25 5.6l6.7 6.7z",
                                                                            }),
                                                                            (0, i.jsx)("path", { d: "M24 7h2v21h-2z" }),
                                                                            (0, i.jsx)("path", {
                                                                    ...
                                                                    (0, i.jsx)("span", { children: "share menu" }),
                                                                ],
                                                            }),
                                                        ],
                                                    }),
                        ...
                        (0, i.jsxs)("footer", {
                            className:
                                "max-w-screen-sm flex flex-col items-center space-y-4  mx-auto py-16 px-4 md:px-6",
                            children: [
                                (0, i.jsx)("span", {
